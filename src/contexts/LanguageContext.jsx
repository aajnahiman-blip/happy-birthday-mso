...
const translations = {
  ar: {
    ...
    openLetter: 'افتح المغلف',
    openLetterDesc: 'انقر لاكتشاف رسالة خاصة مكتوبة بكل حب.',
    openLetterAction: 'فتح الرسالة',
    closeLetterAction: 'إغلاق الرسالة',
    candlesBlown: 'تمّ إطفاء الشموع بالأمنيات',
    wishesLitSky: 'أضاءت أمنياتك السماء',
    featuredPhotos: 'صور مميزة',
    momentsThatGlow: 'لحظات دافئة مميزة',
    latestMemories: 'أحدث الذكريات',
    backgroundSoundtrack: 'الموسيقى الخلفية الاحتفالية',
    pianoSoundtrackDesc: 'أنغام بيانو هادئة ترافق تصفحك لاحتفال محمد سفيان.',
    readyForFinalSurprise: 'هل أنت مستعد للمفاجأة الختامية؟',
    finalSurpriseCTADesc: 'تجربة ختامية فاخرة وسينمائية إهداء لمحمد سفيان M♡S♡O',
    yourFinalMoment: 'لحظتك الأخيرة معي',
    happyBirthdayDearLove: 'حبيبي الغالي',
    finalSurpriseHeroDesc: 'قبل أن تنتهي هذه الرحلة، تركت لك أجمل مفاجأة… لحظة صنعتها من الحب، والذكريات، وكل المشاعر التي أحملها لك.',
    wishHasBeenCast: 'تمت إضاءة أمنياتك',
    tapToOpenGift: 'انقر لفتح الهدية الختامية 💝',
    specialLoveLetterAwaits: 'رسالة حب خاصة تنتظرك...',
    fromMyHeartToMyLove: 'من قلبي إلى حبيبي',
    craftedWithLove: 'صُنِع بحبٍّ خالص لمحمد سفيان',
    enterExperience: 'دخول التجربة الفاخرة',
    cinematicVideos: 'فيديوهات احتفالية',
    privateNotes: 'رسائل خاصة',
    previous: 'السابق',
    next: 'التالي',
    page: 'صفحة',
    loveLetterTag: 'رسالة حب',
    msoBirthdayVideo: 'فيديو عيد ميلاد M♡S♡O',
    muted: 'مكتوم',
    volume: 'الصوت',
  },
  fr: {
    ...
    openLetter: 'Ouvrir l’enveloppe',
    openLetterDesc: 'Cliquez pour découvrir une lettre écrite avec amour.',
    openLetterAction: 'Ouvrir la lettre',
    closeLetterAction: 'Fermer la lettre',
    candlesBlown: 'Bougies soufflées — vœu exaucé !',
    wishesLitSky: 'Vos vœux ont illuminé le ciel',
    featuredPhotos: 'Photos vedettes',
    momentsThatGlow: 'Moments étincelants',
    latestMemories: 'Derniers souvenirs',
    backgroundSoundtrack: 'Musique d’ambiance d’anniversaire',
    pianoSoundtrackDesc: 'Douces mélodies au piano accompagnant votre navigation.',
    readyForFinalSurprise: 'Prêt pour la surprise finale ?',
    finalSurpriseCTADesc: 'Une expérience de fin cinématographique dédiée à Mohamed Soufiane M♡S♡O',
    yourFinalMoment: 'Votre moment final avec moi',
    happyBirthdayDearLove: 'Mon Cher Amour',
    finalSurpriseHeroDesc: 'Avant que ce voyage ne se termine, je t’ai laissé une dernière surprise… un moment fait d’amour, de souvenirs et de tout ce que je porte dans mon cœur pour toi.',
    wishHasBeenCast: 'Votre vœu a été réalisé',
    tapToOpenGift: 'Appuyez pour ouvrir votre cadeau final 💝',
    specialLoveLetterAwaits: 'Une lettre d’amour spéciale vous attend...',
    fromMyHeartToMyLove: 'De mon cœur à mon amour',
    craftedWithLove: 'Créé avec un amour pur pour Mohamed Soufiane',
    enterExperience: 'Entrer dans l’expérience',
    cinematicVideos: 'Vidéos de célébration',
    privateNotes: 'Lettres privées',
    previous: 'Précédent',
    next: 'Suivant',
    page: 'Page',
    loveLetterTag: 'Lettre d’amour',
    msoBirthdayVideo: 'Vidéo d’anniversaire M♡S♡O',
    muted: 'Muet',
    volume: 'Volume',
  },
  en: {
