...
export function Footer() {
  ...
  return (
    <footer className="border-t border-[var(--border)] bg-[rgba(6,7,11,0.92)] backdrop-blur-xl py-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 text-sm text-[var(--text-secondary)] sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
        <div>
          <p className="font-bold text-[#d4af37] tracking-wider">M♡S♡O 💎 | {t('fullName')}</p>
